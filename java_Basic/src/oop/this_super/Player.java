...
//		hp = 50;
	...
	Player(String name, int hp, int a){
		this(name);//다른 생성자의 호출은 생성자 내에서 최상단에 위치해야 합니다.
		System.out.println("Player의 3번 생성자 호출");
		//this.name = name;
//		this.hp = hp;
...
//		else {
//			System.out.println(this.name + " 이(가) " + target.name + " 을 공격합니다.");
//			System.out.println(this.hp - target.hp);
//			System.out.println(this.name + " 의 체력: " + (this.hp - target.hp));
//			System.out.println(this. + " 의 체력: " + (target.hp - this.hp));
//		}
