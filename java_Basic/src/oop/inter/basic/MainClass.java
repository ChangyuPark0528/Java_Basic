...
//		Inter i1 = new Inter(); (x) 인터페이스는 객체를 생성할 수 없는 추상적인 개념입니다.
		
		
		System.out.println("상수: "+ Inter.num);
		Inter.staticMethod(); //static 데이터 호출은 가능합니다.
		
		ImpleClass1 i1 = new ImpleClass1();
        ...
        */
		...
		Inter it1 = new ImpleClass1(); //다형성
		it1.method1();
		it1.parentMethod();
		
		//연산자의 우선순위
		//괄호()-> 참조(.) -> 단항 -> 2항 -> 3항 ->대입
		((ImpleClass1)it1).method2();
