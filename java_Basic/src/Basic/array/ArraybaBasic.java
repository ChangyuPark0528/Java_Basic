...
public class ArraybaBasic {
	...
	public static void main(String[] args) {
		...
		//arr[4] = "문자열" (x)
		arr[4] = 100;
		//arr[5] = 70; (x) index 범위를 초과함
		
		//4. 배열의 총 크기(길이) 확인. -> 배열의 변수명.length
		...
		String[] names = {"박찬규","김철수","박용수"};
		//names = {"박찬규","김철수","박용수","김수발"};(x)
		names = new String[] {"박찬규","김철수","박용수","김수발"};
