	...
	public static void main(String[] args) {
		...
		while(true) {
            ...
            if(menu == 1) {
            	...
            	count++; //다음 사람은 다음인덱스에 저장하기 위해 미리 조치.
            			...
            			menu4: while(true) {
            				...
            				switch(sel) {
            					case 1:
            						...
            						System.out.println("> ");
            						ages[i] = sc.nextInt();
            						System.out.printf("# 나이가 %d세로 정상변경 되었습니다.\n",ages[i]);
            						break;
            					...
            					case 2:
            						...
            						System.out.printf("# 부서가 %s로 정상변경 되었습니다.\n",departments[i]);
            						break; 
            					
            					case 3:
            						System.out.println("# 정보 수정을 취소하고 메인메뉴로 나갑니다.");
            						break menu4;
